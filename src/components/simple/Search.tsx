...
export default function Search() {
  ...
  const onSearchClick = () => {
    ...
    setPopupSeverity("warning");
    setPopupMessage(
      "Note: Đây chỉ là bản demo chạy trên fake API. Mỗi lần tìm kiếm đều trả về cùng một dữ liệu mẫu, nên kết quả không phản ánh logic xử lý thực tế của backend. Mục đích là minh hoạ giao diện, không phải chức năng thật."
    );
    setIsOpen(true);
